...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0..\AmazonMusicRateSwitcher.ps1" -Mode Monitor -Apply -Cdp -CdpLaunch
...
if not exist "%~dp0..\..\tools\SoundVolumeView\SoundVolumeView.exe" powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0..\setup.ps1"
if errorlevel 1 goto setup_failed
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0..\AmazonMusicRateSwitcher.ps1" -Mode Monitor -Apply -Cdp -CdpLaunch -Direct
goto end
